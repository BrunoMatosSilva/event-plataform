                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            <div className="leading-relaxed">
                                ...
                                <span className="text-gray-200 text-sm block">DevFullStack e Instrutor</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a
                            ...
                            target="blank"
                            className="p-4 text-sm text-blue-500 border border-blue-500 uppercase flex items-center rounded font-bold gap-2 justify-center hover:bg-blue-500 hover:text-gray-900transition-colors" >
