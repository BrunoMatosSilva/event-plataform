...
export function Lesson(props: LessonProps) {
    ...
    return (
        <Link to={`/event/lesson/${props.slug}`} className="group">
            ...
            <div className={classNames('rounded border border-gray-500 p-4 mt-2 group-hover:border-purple-500 transition-colors', {
                ...
                <header className="flex item-center justify-between">
                    ...
                    {isLessonAvailable ? (
                        <span className={classNames('text-sm  font-medium flex items-center gap-2', {
                            ...
                            'text-purple-400': !isActiveLesson,
                        })}>
                            <CheckCircle size={20} />
                            Conteúdo liberado
                        </span>
                    ...
                    <span className={classNames('text-xs rounded py-[0.125rem] px-2 text-white border font-bold', {
                        ...
                        'border-purple-400': !isActiveLesson,
                    })}>
